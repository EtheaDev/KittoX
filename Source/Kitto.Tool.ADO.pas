...
/// <summary>
///  Excel export/import tool controllers via ADO for KittoX.
///  Replaces Kitto.Ext.ADOTools.
/// </summary>
unit Kitto.Tool.ADO;
...
type
  ...
  TExportExcelToolController = class(TKXDownloadFileController)
  strict private
  ...
  {$RTTI EXPLICIT PROPERTIES([vcPublic])}
  TUploadExcelToolController = class(TKXUploadFileController)
  strict private
...
initialization
  TKXControllerRegistry.Instance.RegisterClass('ExportExcelTool', TExportExcelToolController);
  TKXControllerRegistry.Instance.RegisterClass('UploadExcelTool', TUploadExcelToolController);
  // Backward compatibility
  TKXControllerRegistry.Instance.RegisterClass('ImportExcelTool', TUploadExcelToolController);

finalization
  TKXControllerRegistry.Instance.UnregisterClass('ExportExcelTool');
  TKXControllerRegistry.Instance.UnregisterClass('ImportExcelTool');
  TKXControllerRegistry.Instance.UnregisterClass('UploadExcelTool');
