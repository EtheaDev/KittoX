...
/// <summary>
///  XSL transformation tool controller for KittoX.
///  Replaces Kitto.Ext.XSLTools.
/// </summary>
unit Kitto.Tool.XSL;
...
initialization
  TKXControllerRegistry.Instance.RegisterClass('XSLTool', TXSLToolController);

finalization
  TKXControllerRegistry.Instance.UnregisterClass('XSLTool');
