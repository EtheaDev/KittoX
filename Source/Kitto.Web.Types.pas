...
const
  MIME_TYPES: array [1 .. 183] of TMIMEType = (
  (Ext: '.svg'; MimeType: 'image/svg+xml'), (Ext: '.svgz'; MimeType: 'image/svg+xml'),
  (Ext: '.webp'; MimeType: 'image/webp'), (Ext: '.ico'; MimeType: 'image/x-icon'),
  (Ext: '.json'; MimeType: 'application/json'), (Ext: '.woff'; MimeType: 'font/woff'),
