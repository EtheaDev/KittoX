...
/// <summary>
///  Text/CSV/XML export tool controllers for KittoX.
///  Replaces Kitto.Ext.Tools.
/// </summary>
unit Kitto.Tool.Export;
...
initialization
  TKXControllerRegistry.Instance.RegisterClass('ExportCSVTool', TExportCSVToolController);
  TKXControllerRegistry.Instance.RegisterClass('ExportTextTool', TExportTextToolController);
  TKXControllerRegistry.Instance.RegisterClass('ExportXMLTool', TExportXMLToolController);

finalization
  TKXControllerRegistry.Instance.UnregisterClass('ExportCSVTool');
  TKXControllerRegistry.Instance.UnregisterClass('ExportTextTool');
  TKXControllerRegistry.Instance.UnregisterClass('ExportXMLTool');
