...
type
  ...
  public
    [YamlSubNode('Connection', TEFDBDBXConnectionConfig, 'DBExpress connection parameters')]
    property ConnectionConfig: TEFDBDBXConnectionConfig read GetConnectionConfig;
  end;
...
procedure TEFDBDBXConnection.InternalCommitTransaction;
begin
...
procedure TEFDBDBXConnection.InternalRollbackTransaction;
begin
  FConnection.RollbackFreeAndNil(FTransaction);
end;

procedure TEFDBDBXConnection.InternalStartTransaction;
begin
...
function TEFDBDBXAdapter.GetConnectionConfig: TEFDBDBXConnectionConfig;
begin
