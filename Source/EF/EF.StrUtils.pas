...
/// <summary>
///	 Returns a Valid filename: if and invalid char was present into string
///	 it's replaced with ValidChar ('_' by default)
///  If SpaceIsValid is False also spaces are replaced
///	</summary>
function ValidFileName(const FileName : string; ValidChar : Char = '_';
  SpaceIsValid : boolean = False) : String;
...
function ValidFileName(const FileName : string; ValidChar : Char = '_';
  SpaceIsValid : boolean = False) : String;
begin
  //not valid chars:  \/:*?"<>|  and space if SpaceIsValid is false
  Result := FileName;
