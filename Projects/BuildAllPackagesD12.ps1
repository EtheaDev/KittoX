<#
.SYNOPSIS
    Rebuilds all KittoX packages (Core + Enterprise) for Delphi 12.
...
.DESCRIPTION
    ...
    bitnesses are valid for D12 design-time packages because the IDE
...
.EXAMPLE
    .\BuildAllPackagesD12.ps1 -Platform Win64 -Target Build
