<#
.SYNOPSIS
    Rebuilds all KittoX packages (Core + Enterprise) for Delphi 10.4.
...
.DESCRIPTION
    ...
    Win32: the Delphi 10.4 IDE itself is 32-bit and can only load Win32
...
.EXAMPLE
    .\BuildAllPackagesD10_4.ps1
    # Rebuilds Core + Enterprise for D11, Win32, Release.

.EXAMPLE
    .\BuildAllPackagesD10_4.ps1 -Target Build -Config Debug
...
# Win32 is the only valid platform for design-time packages on D10_4
